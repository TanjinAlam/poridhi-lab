...
with open('/Users/piash/DevOps/Poridi Lab/systemd/script/mysql-setup.sh', 'r') as file:
...
git clone https://github.com/TanjinAlam/systemd-node-applicaiton.git /tmp/scripts
chmod +x /tmp/scripts/setup.sh


# Create .env file with database connection info
cat > /tmp/scripts/.env << EOL
